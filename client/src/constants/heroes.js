export const HEROES_BY_TITLE = {
  ...
  "Sparkling Cluster": [
    ...
    "Sparkling Cluster is a stunning fine jewelry collection that recalls enduring commitment to making brilliant celebrations shine even brighter with magnificent diamonds.",
    "/sparkling-cluster",
  ],
  "Forget-Me-Not": [
